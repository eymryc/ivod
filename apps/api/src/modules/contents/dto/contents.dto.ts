...
export class QueryContentsDto {
  ...
  @ApiPropertyOptional({ example: true, description: 'Contenus exclusifs iVOD uniquement' })
  @IsOptional()
  @Transform(({ value }) => value === true || value === 'true')
  @IsBoolean()
  isExclusive?: boolean;

  @ApiPropertyOptional({ example: 30, description: 'Publiés dans les N derniers jours' })
  @IsOptional() @Type(() => Number) @IsInt() @Min(1)
  publishedWithinDays?: number;

  @ApiPropertyOptional({
    example: 'ACTION,AVENTURE',
    description: 'Codes genres multiples (OR), séparés par virgule',
  })
  @IsOptional()
  @IsString()
  genreCodes?: string;
  ...
  @ApiPropertyOptional({
    example: 'id1,id2,id3',
    description: 'IDs contenus (ordre préservé dans la réponse)',
  })
  @IsOptional()
  @IsString()
  ids?: string;
...
export class CreateContentDto {
  ...
  @ApiPropertyOptional({
    example: 'MINUS_16',
    enum: ['ALL', 'MINUS_12', 'MINUS_16', 'MINUS_18'],
    description: 'Classification d\'âge (code)',
  })
  @IsOptional()
  @IsString()
  @IsIn(['ALL', 'MINUS_12', 'MINUS_16', 'MINUS_18'])
